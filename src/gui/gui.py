...
class Gui:
    def __init__(self, width, height, creatures, world, clock, statistics, speed):
        self.screen = pygame.display.set_mode((width, height))
        self.interface = Interface((601, 0), (width-600, height), world, statistics, clock, self.screen, speed)
